...
package Control . Junctions is
   ...
   generic
      with package Pass_Signature is new Joint_Pass_Signature (<>);
      use Pass_Signature;
   ...
   generic
      with package Map_Signature is new Joint_Map_Signature (<>);
      use Map_Signature;
   ...
   generic
      with package Pipe_Signature is new Joint_Pipe_Signature (<>);
      use Pipe_Signature;
